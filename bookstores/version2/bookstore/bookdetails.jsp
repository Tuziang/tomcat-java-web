...
%>
    ...
    <strong><a href="<%=request.getContextPath()%>/catalog">继续购物</a></strong>
<% 
     return;
   }
%>
...
<p><strong><a href="<%=request.getContextPath()%>/catalog?Add=<%=bookId%>">加入购物车</a>&nbsp; &nbsp; &nbsp;
<a href="<%=request.getContextPath()%>/catalog">继续购物</a></p></strong>
